...
//
//
//@interface AIMediaBusContext : NSObject
//
//{
//	
//    CFRunLoopRef        runLoop;
//	
//    AIMediaBusSource*        source;
//	
//}
//
//@property (readonly) CFRunLoopRef runLoop;
//
//@property (readonly) AIMediaBusSource* source;
//
//
//
//- (id)initWithSource:(AIMediaBusSource*)src andLoop:(CFRunLoopRef)loop;
//
//
//@end
